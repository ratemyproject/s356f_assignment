...
<?php 
    ...
    $id = $_POST['username'];
    $pw = $_POST['pw'];
	$sql = "select * from acc where username = '".$id."' and password='".md5($pw)."'";
	...
	if ($count>0) {
		...
		if($row['Type']==1) $_SESSION['rest'] = 1;
		else $_SESSION['rest'] = 0;
		header("location: index.php");
	}	
    else {
	    echo "<p style='color:#0000FF; padding:25px 0 25px 15px; text-align:center'>Login Failed! Redirecting....</p>";
